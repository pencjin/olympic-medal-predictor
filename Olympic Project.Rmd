...
Choice of best model: The model we have chosen for this section is 2.3 Eileen’s modeld-medal vs combined, which is the main effects + interaction. This model demonstrates the relationship between the total number of athletes participating for a country, the total number of events a country participates in, and the number of medals that an individual athlete has earned. We selected this model as the best model for our analysis because it has the highest adjusted rsq (5.81%) and the lowest rmse (0.446) , indicating the most reliable and accurate predictions of medals per athlete.  
